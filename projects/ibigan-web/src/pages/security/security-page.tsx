    ...
    <div className="container py-6 max-w-3xl">
        ...
        <CardContent>
          ...
          {step === 'setup' && (
            <div className="space-y-4">
              ...
              <Form {...confirmForm}>
                <form onSubmit={confirmForm.handleSubmit(d => confirmMutation.mutate(d))} className="space-y-3">
      ...
      <AlertDialog open={showDisableDialog} onOpenChange={setShowDisableDialog}>
        <AlertDialogContent>
          ...
          <Form {...disableForm}>
            <form onSubmit={disableForm.handleSubmit(d => disableMutation.mutate(d))} className="space-y-3 px-6 pb-2">
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              onClick={disableForm.handleSubmit(d => disableMutation.mutate(d))}
